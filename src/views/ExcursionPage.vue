        ...
        <a-row :gutter="[12, 12]" class="text justify-center d-flex">
          ...
          <a-col :span="24" :md="12">
            <div style="float: right;">
              <MdiIcon style="opacity: 0.7; cursor: pointer;" @click="startShare()" name="share-variant-outline"
            ...
            <div>
              <b>Мин. возраст:</b> {{ excursion.minAge }}
            </div>
            <div v-if="_.isEmpty(excursion.dates)">
              <b>Заявка за:</b> {{ excursion.deadline }} дн.
            </div>
            <div>
              <b>ОВЗ доступность: </b>
            ...
            <div v-if="excursion.guides && excursion.guides?.length > 0">
              ...
              <div class="d-flex flex-wrap">
                <a-card v-for="guide in excursion.guides" style="border: #239FCC 1px solid;"
                  class="ma-8 pa-4 text guide_button" hoverable @click="router.push(`/guide?_id=${guide._id}`)">
          ...
          <div class="mt-16 mb-16">
            ...
            <div>
              ...
              <VueDatePicker v-model="fullinfo.date" locale="ru-Ru" calendar-class-name="dp-custom-calendar"
                ...
                <template #input-icon>
                  <MdiIcon style="font-size: 20px; color: rgba(95, 95, 95, 0.65);" name="calendar-outline"
                    class="ml-8" />
                </template>
              </VueDatePicker>
            </div>
...
.additional-info {
  margin-top: 20px;
  font-size: clamp(1rem, 0.9006rem + 0.2841vw, 1.125rem);
}
