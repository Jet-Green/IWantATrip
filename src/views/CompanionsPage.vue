        ...
        <a-row :gutter="[8, 8]">
          ...
          >
            <a-card class="card">
              ...
              <div :class="[companion.companionGender == 'Male' ? 'male':companion.companionGender == 'Female'?'female':'not-matter']">
                <span class="mdi mdi-gender-male-female"></span
                >{{ companion.companionGender == "Male" ? "Мужчину" :companion.companionGender == "Female"? "Женщину":"Не важно" }}
              </div>
              <div>
