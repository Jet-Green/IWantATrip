      ...
      <form action="POST" @submit.prevent="submit">
        <a-row :gutter="[16, 16]">
          ...
          <a-col :xs="24" :md="12">Тип тура
            <div>
              <a-select v-model:value="form.tripType" style="width: 100%" :options="typeOfTrip"></a-select>
            </div>
          </a-col>
          ...
          <a-col :span="24">
            Маршрут
            <a-textarea placeholder="Глазов-Пермь 300км" size="large" v-model:value="form.tripRoute"></a-textarea>
          </a-col>
