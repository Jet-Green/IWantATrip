...
<template>
  <a-row :gutter="[8, 8]" class="mt-8">
    <a-col
      ...
      :sm="12"
      :xs="24"
      v-if="rejectedTrips.length > 0"
      v-for="(trip, index) of rejectedTrips"
      :key="index"
    >
      <a-card class="card" hoverable>
        ...
        <div><span class="mdi mdi-compass-outline"></span> {{ trip.startLocation.name }}</div>
        <div>
    ...
    <a-col :span="24" v-else> Нет отказаных туров </a-col>
  </a-row>
</template>
