...
async function updateContract() {
    let res = await contractStore.updateContract(contractForm);
    ...
    if (res.status == 200) {
        ...
        router.push('/cabinet/admin-contracts-list')
    }
}
const addFounders = () => {
...
onMounted(async () => {
    let res = await contractStore.getContractById(route.query._id)
    userEmails.value = res.data.userEmails

    delete res.data.userEmails
...
<template>
    <div>
        ...
        <a-row type="flex" justify="center" class="mb-8">
            <a-col :xs="22" :lg="16">
                <h2>Договор. <span style="color: #ff6600;">Изменение</span> в Тинькофф</h2>
                ...
                <form @submit.prevent="submit" class="ma-16">
                    <a-row :gutter="[16, 16]">
                        ...
                        <a-col :span="24" :md="12">
                            ...
                            <a-input placeholder="Ogonek" v-model:value="contractForm.billingDescriptor"
                                required></a-input>
                        </a-col>
                        <a-col :span="24" :md="12">
                        ...
                        <a-col :span="12">
                            email
                            <a-input placeholder="fleshtur19@gmail.com" v-model:value="contractForm.email"
                                required></a-input>
                        </a-col>
                        <a-col :span="12">
                            Сайт
                            <a-input placeholder="https://glazov-flash.ru" v-model:value="contractForm.siteUrl"
                                required></a-input>
                        </a-col>
                        ...
                        <a-col :span="24">
                            ...
                            <a-row :gutter="[4, 4]">
                                ...
                                <a-col :xs="12">
                                    Почтовый индекс
                                    <a-input placeholder="427620" v-model:value="contractForm.addresses[0].zip"
                                        required></a-input>
                                </a-col>

                                <a-col :xs="12">
                                    Город/поселок
                                    <a-input placeholder="Глазов" v-model:value="contractForm.addresses[0].city"
                                        required></a-input>
                                </a-col>
                                <a-col :xs="24">
                                    Улица
                        ...
                        <a-col :span="24">
                            ...
                            <a-row :gutter="[4, 4]">
                                ...
                                <a-col :xs="12">
                                    Почтовый индекс
                                    <a-input placeholder="427620" v-model:value="contractForm.addresses[1].zip"
                                        required></a-input>
                                </a-col>

                                <a-col :xs="12">
                                    Город/поселок
                                    <a-input placeholder="Глазов" v-model:value="contractForm.addresses[1].city"
                                        required></a-input>
                                </a-col>
                                <a-col :xs="24">
                                    Улица
                        ...
                        <a-col :span="24">
                            ...
                            <a-row v-for="(item, index) in contractForm.founders.individuals" :key="index"
                                align="middle" class="mb-4 d-flex" :gutter="[4, 4]">
                                <a-col :xs="22">
                                    <a-row :gutter="[4, 4]">
                                        <a-col :xs="12">
                                            Имя
                                            <a-input placeholder="Иван" v-model:value="item.firstName"
                                                required></a-input>
                                        </a-col>
                                        <a-col :xs="12">
                                            Фамилия
                                            <a-input placeholder="Иванов" v-model:value="item.lastName"
                                                required></a-input>
                                        </a-col>
                                        <a-col :xs="12">
                                            Гражданство
                                            <a-input placeholder="Россия" v-model:value="item.citizenship"
                                                required></a-input>
                                        </a-col>
                                    </a-row>
                                </a-col>
                        ...
                        <a-col :xs="12">
                            Отчество
                            <a-input placeholder="Иванович" v-model:value="contractForm.ceo.middleName"
                                required></a-input>
                        </a-col>
                        <a-col :xs="12">
                            Телефон
                            <a-input placeholder="89128523316" v-model:value="contractForm.ceo.phone"
                                required></a-input>
                        </a-col>
                        <a-col :xs="12">
                            Гражданство
                        ...
                        <a-col :xs="12">
                            БИК
                            <a-input placeholder="049401871" v-model:value="contractForm.bankAccount.bik"
                                required></a-input>
                        </a-col>
                        <a-col :xs="12">
                            Описание платежа
                        ...
                        <a-col :span="24">
                            Комиссия
                            <a-input-number placeholder="7"
                                v-model:value="contractForm.bankAccount.tax"></a-input-number>
                        </a-col>
                        ...
                        <a-col :span="12">
                            <a-input placeholder="OrangeData" v-model:value="contractForm.fiscalization.company"
                                disabled></a-input>
                        </a-col>
                        <a-col :span="12">
                            Привязанные кабинеты:
                            <div v-for="email of userEmails">
                                <b>
                                    {{ email }}
                                </b>
                            </div>
                            <!-- <a-input placeholder="fleshtur19@gmail.com"
                                v-model:value="contractForm.userEmails[0]"></a-input> -->
                        </a-col>
                        <a-divider></a-divider>
