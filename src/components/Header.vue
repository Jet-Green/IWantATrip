      ...
      <a-col :xs="22" :lg="16">
        <a-row type="flex" justify="space-between">
          ...
          <a-col v-if="!sm" :span="12" class="top_menu">
            ...
            <span v-if="user.isAuth" class="mdi mdi-24px mdi-home" @click="toComponentFromMenu('Cabinet')"
              style="cursor: pointer" cancelText="отмена">
            </span>
            <span v-if="!user.isAuth" class="mdi mdi-24px mdi-login" @click="toComponentFromMenu('RegForm')"
