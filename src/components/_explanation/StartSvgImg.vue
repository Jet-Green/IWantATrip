<script setup></script>
<template>
  <svg version="1.1"  width="100%" height="100%" viewBox="0 0 296.8 96.04" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <filter
        id="filter78986"
        x="-.6585"
    ...
    <g transform="translate(-.4284 -.4911)">
      <g transform="matrix(.8491 0 0 .8739 .1712 .3018)">
        <g stroke-width="0">
          ...
          <circle
            transform="translate(10.7 5.227)"
            cx="144.5"
            cy="30.78"
            r="12.16"
            fill="#bcc663"
        ...
        <g transform="translate(6.1 -107.1)" id="bird2">
          <path
          ...
          />
          <path
            transform="translate(-16.35,111.2) "
            d="m254.8 22.34s1.146-2.017 2.121-2.525c1.198-0.6246 1.555-0.4377 1.555-0.4377"
            fill="none"
            stroke="#000"
            stroke-width=".3501"
            id="wings"
        ...
        <g transform="translate(-.5592 -113.8)" id="bird1">
          <path
            d="m238.3 133.7s-1.146-2.017-2.121-2.525c-1.198-0.6246-1.555-0.4377-1.555-0.4377"
            fill="none"
            stroke="#000"
